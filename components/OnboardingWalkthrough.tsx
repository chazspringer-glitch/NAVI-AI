...
const STEPS: Step[] = [
  ...
  },
  {
    icon: "📂",
    title: "The Hub Menu",
    body: "Tap the menu icon (bottom right) to open the Hub. Inside you'll find every tool NAVI offers — organized by Business, Life, Learning, and Financial.",
    accent: "#C9A227",
  },
  {
    icon: "🚛",
        ...
        <div style={{
          ...
          {step === 0 || step === total - 1 ? (
            ...
            <div style={{
              ...
              filter: `drop-shadow(0 0 14px ${current.accent}55)`,
            }}>
              {current.icon}
            </div>
          )}
          ...
          {/* Step counter */}
          <div style={{ fontSize: 9, color: "#475569", letterSpacing: "0.14em", marginBottom: 16 }}>
            {step + 1} / {total}
          </div>
